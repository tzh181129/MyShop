    ...
    <form class="form-horizontal" method="post" action="">
        ...
        <div class="form-group">
            <div class="col-sm-offset-6">
                <div class="col-sm-3">
                    <input type="submit" class="btn btn-success btn-block" value="发布商品">
                </div>
                    <div class="col-sm-3">
                        <a href="<?php echo e(url('shop')); ?>" ><p style="margin-top:12%;">商品列表</p></a>
                </div>
...
<?php echo $__env->make('common.businesshome', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>