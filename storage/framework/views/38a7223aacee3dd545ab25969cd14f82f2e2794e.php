...
<div class="container a">
    <div class="row">
        ...
        <div class="col-sm-3"><br/><br/><br/><?php echo e($messageRes['shop_name']); ?></div>
        <div class="col-sm-3"><br/><br/><br/><p>关注量：<?php echo e($messageRes['num']); ?></p></div>

        <div class="col-sm-4 col-sm-offset-0" >
            <br/><br/><br/>
            <a href="<?php echo e(url('shoporder')); ?>?id=<?php echo e($messageRes['shop_id']); ?>" style="float:left;">店铺订单</a>
            <a href="<?php echo e(url('release')); ?>" style="float:right;">发布商品</a>
    </div>
    ...
    <div class="row" style="margin-top:3%;">
        <div class=" col-sm-offset-3">
            <div class="col-sm-4">
                <p>店铺详情:</p></div><div><p><?php echo e($messageRes['shop_details']); ?></p>
        </div>
    </div>
    </div>
    <div class="row">
        <div class=" col-sm-offset-3">
            <div class="col-sm-4">
                <p>店铺广告:</p></div><div><p><?php echo e($messageRes['shop_advert']); ?></p>
            </div>
        </div>
    </div>
