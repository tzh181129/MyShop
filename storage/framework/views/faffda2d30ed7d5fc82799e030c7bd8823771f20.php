    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo e(url('release')); ?>">发布商品 <span class="sr-only">(current)</span></a></li>
                <li><a href="<?php echo e(url('business')); ?>">创建店铺</a></li>
                <li><a href="<?php echo e(url('shop')); ?>">商品列表</a></li>
