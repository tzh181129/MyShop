...
<div class="container a">
    ...
    <div class="row">
        <div class="col-sm-2 col-sm-offset-3"><a href="{{url('order')}}">全部</a></div>
        <div class="col-sm-2"><a href="{{url('unshipped')}}">未发货</a></div>
        <div class="col-sm-2"><a href="{{url('already')}}">已发货</a></div>
        <div class="col-sm-2"><a href="{{url('orderfinish')}}">已收货</a></div>
    </div>
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                @if($message->finish_time!=0)
                    <p>已收货 &nbsp;&nbsp;&nbsp;&nbsp;<a href="http://localhost:8000/orderdel?id={{$message->id}}"> 删除订单</a></p>
                @else
