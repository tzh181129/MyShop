    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="{{url('release')}}">发布商品 <span class="sr-only">(current)</span></a></li>
                <li><a href="{{url('business')}}">创建店铺</a></li>
                <li><a href="{{url('shop')}}">商品列表</a></li>
                <li><a href="{{url('cart')}}"><p id="text"></p></a></li>
                <li><a href="{{url('information')}}">个人中心</a></li>
            </ul>
